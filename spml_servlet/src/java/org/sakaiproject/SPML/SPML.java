...
public class SPML implements SpmlHandler  {
  ...
  /**
   * Add the user to the SPML_UPDATED_USERS table as a trigger to 
   * the external Peoplesoft integration script.
   * @param u
   */
  ...
  private void synchCourses(List<String> uctCourse, String userEid) {
    ...
    for (EnrollmentSet enrolledSet : enrolled) {
      
      String courseEid =  enrolledSet.getEid();
